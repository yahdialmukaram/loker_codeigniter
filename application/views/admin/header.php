			...
			<div class="col-md-3 left_col">
				<div class="left_col scroll-view">
					<div class="navbar nav_title" style="border: 0;">
						<a href="#" class="site_title"><i class="fa fa-paw"></i> <span><?=	$this->session->userdata('username');?>
							</span></a>
					</div>
					...
					<div class="profile clearfix">
						...
						<div class="profile_info">
							<h2>
								<span>Welcome</span> <?=$this->session->userdata('level');?>
					...
					<div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
						<div class="menu_section">
							...
							<ul class="nav side-menu">
								...
								<li><a href="<?=base_url('c_admin')?>"><i class="fa fa-home"></i> Home <span
						...
						<ul class="nav navbar-nav navbar-right">
							<li class="">
								...
								<ul class="dropdown-menu dropdown-usermenu pull-right">
									...
									<li><a href="<?=base_url();?>c_login"><i class="fa fa-sign-out pull-right"></i> Log
											Out</a></li>
								</ul>
							</li>
						</ul>
